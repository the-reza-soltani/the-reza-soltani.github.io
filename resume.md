...
Architecture: Microservices, Distributed Systems, DDD, CQRS, Event-Driven
Messaging & Streaming: RabbitMQ, Kafka
DevOps & Cloud: Docker, Kubernetes, Nginx, Caddy, GitLab CI/CD, Github Actions
Performance Optimization: Caching, Load Balancing, Reverse Proxy, Profiling
Testing & Security: Unit Testing, E2E Testing, API Security, OAuth, Keycloak
Programming: JavaScript, TypeScript, Golang, Bash, Linux, Git
Experience
Daal - Backend Developer | Feb 2024 – Present | Remote
...
Technologies: Node.js, NestJS, PostgreSQL, Prisma ORM, RabbitMQ, Kafka, Docker, GitLab CI/CD, Redis
Stichting Ponder Source - Software Engineer | Jan 2023 – Feb 2024 | Remote
...
Xaniis - Software Engineer | Feb 2021 – Feb 2023 | Remote
...
Technologies: Node.js, Kubernetes, Docker, Nginx, PostgreSQL, RabbitMQ, Redis

Tarnamagostar - Backend Developer | Jun 2020 – Jan 2021 | Remote
...
Technologies: Node.js, NestJS, RabbitMQ, Docker, CI/CD, TypeScript, ELK Stack

CITEK - Backend Developer | Jan 2019 – May 2020 | Remote
...
Technologies: Node.js, Express.js, PostgreSQL, Docker, Nginx, Redis, OAuth
Freelance - Software Developer | Jan 2017 – Dec 2018 | Remote
...
Technologies: Node.js, PHP, WordPress, MySQL, JavaScript, Git, Linux
...
Education
University of Tabriz — Master's Degree in Intelligent Simulator Design
