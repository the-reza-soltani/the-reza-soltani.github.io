...
export type AboutBadge = {
  label: string
  icon: 'network' | 'layers' | 'zap' | 'boxes' | 'globe' | 'shield'
}
...
export const resume = {
  ...
  about: {
    ...
    badges: [
      ...
      { label: 'Hexagonal Architecture', icon: 'layers' },
      { label: 'Event-Driven Design', icon: 'zap' },
      { label: 'DDD & CQRS', icon: 'boxes' },
      { label: 'Remote', icon: 'globe' },
      { label: 'Production Reliability', icon: 'shield' },
